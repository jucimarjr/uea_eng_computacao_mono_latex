\chapter{T\'{i}tulo do Quarto Cap\'{i}tulo}
...
\renewcommand{\baselinestretch}{0.5}  % dist\^{a}ncia entre linhas
\begin{codigo}[htb]
\fontsize{9pt}{9pt}\selectfont
      \begin{boxit}  % coloca o c\'{o}digo dentro de um Box
				\vspace{2mm}
				\VerbatimInput[xleftmargin=8mm,numbers=left,obeytabs=true]{source/arquivo.cpp}
			\end{boxit}
   \caption{\it C\'{o}digo C++}
...
\fontsize{9pt}{9pt}\selectfont
   \begin{boxit}  % coloca o c\'{o}digo dentro de um Box
      \vspace{2mm}
      \VerbatimInput[xleftmargin=8mm,numbers=left,obeytabs=true]{source/calculadora.erl}
   \end{boxit}
   \caption{\textit{C\'{o}digo Erlang} }
   \label{code:funcoes}
\end{codigo}
